...
В игре должен быть минималистичный интерфейс. В игре должен быть понятный геймплей (понимаяние игры без обучения, за несколько минут), а также хорошая производительность (игра не должна виснуть на слабых девайсах).
